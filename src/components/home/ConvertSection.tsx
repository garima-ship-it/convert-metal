    ...
    <>
      ...
      <section className="conv-desktop" style={{ background: 'black', width: '100%', height: 640, overflow: 'hidden', position: 'relative' }}>
        ...
        <button onClick={handleConvertClick}
          style={{ position: 'absolute', left: 85, top: 484, background: 'white', borderRadius: 13, height: 79, width: 377, display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer' }}>
      ...
      <section className="conv-mobile" style={{ display: 'none', background: 'black', padding: '40px 22px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <button onClick={handleConvertClick}
            style={{ background: 'white', borderRadius: 13, height: 45, width: 250, display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer' }}>
