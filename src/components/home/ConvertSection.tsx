  ...
  return (
    <>
      ...
      <section className="conv-desktop" style={{ background: '#080808', padding: '48px 60px' }}>
        {/* Banner — black bg with gold glow, rounded, margins on sides */}
        <div style={{
          position: 'relative',
          background: '#000000',
          borderRadius: 20,
          ...
          {/* Gold conic glow — top left, exactly like Figma */}
          <div style={{
            position: 'absolute',
            left: -187,
            top: -531,
          ...
          <div style={{ flex: 1, padding: '56px 58px', position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', gap: 28, justifyContent: 'center' }}>
            ...
            {/* Heading — gold gradient exactly like Figma */}
            <h2 style={{
              fontSize: 54, fontWeight: 800, lineHeight: '62px', margin: 0,
              background: 'linear-gradient(180deg, #ffe38d 0%, #f3c770 38%, #e7ac53 75%)',
            ...
            <button onClick={handleClick} style={{
              ...
              borderRadius: 8, height: 48, width: 228, border: 'none', cursor: 'pointer',
          ...
          {/* Right — video sitting directly on black bg, no box */}
      ...
      <section className="conv-mobile" style={{ display: 'none', background: '#080808', padding: '28px 16px' }}>
        <div style={{
          ...
          {/* Gold glow mobile */}
          <div style={{
            position: 'absolute', left: -100, top: -200, width: 400, height: 400,
            background: 'conic-gradient(from 90deg at 50% 50%, rgba(224,192,48,0.2) 0%, rgb(224,192,48) 5%, rgba(224,192,48,0) 40%, rgba(0,0,0,0) 100%)',
            transform: 'rotate(-90deg)', opacity: 0.5, pointerEvents: 'none', zIndex: 0,
          }} />
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            {/* Heading */}
            <h2 style={{
              fontSize: 30, fontWeight: 800, lineHeight: '38px', marginBottom: 20,
              background: 'linear-gradient(180deg, #ffe38d 0%, #f3c770 38%, #e7ac53 75%)',
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
            }}>
              Convert Your Plastic Payment Card to Metal
            ...
            <button onClick={handleClick} style={{
              background: 'linear-gradient(135deg, #ffe38d 0%, #f3c770 38%, #e7ac53 75%)',
              borderRadius: 10, height: 46, width: '100%', border: 'none', cursor: 'pointer',
